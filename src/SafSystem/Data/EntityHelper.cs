...
namespace Ataoge.Data
{
    ...
    public static class EntityHelper
    {
        ...
        public static Type GetPrimaryKeyType(Type entityType)
        {
            ...
            throw new SafException("Can not find primary key type of given entity type: " + entityType + ". Be sure that this entity type implements IEntity<TPrimaryKey> interface");
        }
    }
}