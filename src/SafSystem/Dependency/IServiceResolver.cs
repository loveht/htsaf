...
namespace Ataoge.Dependency
{
    ...
    public interface IServiceResolver
    {
        ...
        /// </summary> 
        /// <typeparam name="T">Type of the object to get</typeparam>
        /// <param name="overridedArguments">Overrided arguments to be used when to be used construction。</param>
        /// <returns>The object instance</returns>
        T Resolve<T>(object overridedArguments);
        ...
        /// </summary> 
        /// <param name="type">Type of the object to get</param>
        /// <param name="overridedArguments">Constructor arguments</param>
        /// <returns>The object instance</returns>
        object Resolve(Type type, object overridedArguments);
