...
namespace Ataoge.Logging
{
    ...
    public class ExceptionFormatter
    {
        ...
        /// </summary>
        public static string Header = Resources.Default.ExceptionFormatterHeader;

        private const string LineSeparator = "======================================";
        private IDictionary<string, object> additionalInfo;
        ...
        public ExceptionFormatter()
            : this(new Dictionary<string, object>(), string.Empty)
        {
        }
        ...
        /// </param>
        public ExceptionFormatter(IDictionary<string, object> additionalInfo, string applicationName)
        {
        ...
        public string GetMessage(Exception exception)
        {
            ...
            eventInformation.AppendFormat("{0}\n\n", this.additionalInfo[Header]);

            eventInformation.AppendFormat("\n{0} {1}:\n{2}",
                                          Resources.Default.ExceptionSummary, this.applicationName, LineSeparator);
            ...
            if (exception != null)
            {
                ...
                do
                {
                    eventInformation.AppendFormat("\n\n{0}\n{1}", Resources.Default.ExceptionDetails, LineSeparator);
                    eventInformation.AppendFormat("\n{0}: {1}", Resources.Default.ExceptionType, currException.GetType().FullName);
                    ...
                    {
                        eventInformation.AppendFormat("\n\n{0} \n{1}",
                                                      Resources.Default.ExceptionStackTraceDetails, LineSeparator);
            ...
            foreach (PropertyInfo propinfo in arrPublicProperties)
            {
                ...
                if (propinfo.Name != "InnerException" && propinfo.Name != "StackTrace")
                {
                    if (propinfo.CanRead && propinfo.GetIndexParameters().Length == 0)
                    {
                        ...
                        {
                            propValue = Resources.Default.PropertyAccessFailed;
                        }
        ...
        {
            IDictionary<string, object> currAdditionalInfo;
            ...
            if (propinfo.Name == "AdditionalInformation")
            {
                if (propValue != null)
                {
                    ...
                    currAdditionalInfo = (IDictionary<string, object>)propValue;
